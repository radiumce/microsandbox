...
Examples:
  python -m mcp_server.main_sdk
  python -m mcp_server.main_sdk --transport streamable-http --port 9000
  python -m mcp_server.main_sdk --transport sse --host 0.0.0.0 --enable-cors
        """,
    )
